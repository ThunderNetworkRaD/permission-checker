// Test the package in Node.js environment (ESM)
import { checkSingle, checkList } from './dist/esm/index.mjs';

console.log('=== Testing in Node.js (ESM) ===');
